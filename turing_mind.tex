...
\begin{enumerate}[label=(\alph*)] % Using (a), (b), (c) labels
...
Changes                        & \hspace*{1em}\textquotedbl = Mutations \\ % Used \textquotedbl for ditto mark
Natural selection              & \hspace*{1em}\textquotedbl = Judgment of the experimenter \\ % Used \textquotedbl for ditto mark
\end{tabular}
\end{center}
